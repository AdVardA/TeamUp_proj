...
#to implement a user registration page on Django using UserCreationForm
...
class user_bio_form(forms.ModelForm):
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control ps-5'}))
    last_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control ps-5'}))
    year = datetime.now()
...
class user_academy_form(forms.ModelForm):
...
class user_sport_form(forms.ModelForm):
